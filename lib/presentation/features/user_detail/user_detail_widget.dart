...
import 'package:sof/presentation/features/common_widget/cupertino_bookmark_button.dart';
...
Widget buildDetailPageForUserReputation(
   { BuildContext? context,
      item.Items? userSofItem, }) {
  int currentPage = 1;      
                        ...
                        Container(
                          ...
                          decoration: BoxDecoration(
                            ...
                            image: DecorationImage(
                                image: NetworkImage(userSofItem!.profileImage!), fit: BoxFit.cover),
                          ),
                        ),
                        Padding(
                          padding:
                              EdgeInsets.symmetric(horizontal: SizeConfig.smallPadding),
                          child: Text("${userSofItem.displayName!}'s  Reputation",
                                ...
                                itemBuilder: (context, index) {
                                  if ((index+3) > items.length && currentPage<= 25 ) {
                                       ...
                                       Future.delayed(const Duration(milliseconds: 1000),(){ 
                                        ...
                                        itemsProvider.fetchUserReputationList(startPage: '$currentPage',pageSize: '100', userId: userSofItem.accountId!.toString());
                                    });
