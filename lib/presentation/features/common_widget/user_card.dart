...
class UserCard extends StatelessWidget {
  ...
  UserCard({Key? key, required this.userModelData}) : super(key: key);
  int apiFirstCall = 0;
  @override
  Widget build(BuildContext context) {
    ...
    return InkWell(
      onTap: (() { 
       callBottomSheet(context,userModelData);
      }),
      child: SizedBox(
                ...
                Container(
                  ...
                  decoration: BoxDecoration(
                    ...
                    image: DecorationImage(
                        image: NetworkImage(userModelData.profileImage!),
                        fit: BoxFit.cover),
                  ),
                ),
                    ...
                    children: [
                      SizedBox(
                          ...
                          child: Row(
                            children: [
                              ...
                              Text(userModelData.displayName!,
                      ...
                      Row(
                        ...
                        children: [
                          ...
                          Text(
                            userModelData.reputation == null
                                ? ""
                                : userModelData.reputation.toString(),
                          ...
                          Text(
                            userModelData.creationDate == null
                                ? ""
                                : FunctionHelper.getBirthDateInstead (
                                    userModelData.creationDate.toString()),
                            style: Theme.of(context).textTheme.caption,
                          ),
                        ],
                      ),
                      ...
                      Row(
                        children: [
                          ...
                          SizedBox(
                            ...
                            child: Text(
                              userModelData.location == null
                                  ? ""
                                  : userModelData.location.toString(),
                              style: Theme.of(context).textTheme.caption,
                            ),
                          ),
                        ],
   ...
   callBottomSheet(BuildContext context, Items itemData){
          ...
          builder: (BuildContext context) {
            return SingleChildScrollView(
              child: SizedBox(
                ...
                child:   buildDetailPageForUserReputation(
                            context: context, 
                            userSofItem: itemData
                        ),
            ),
            );
          },
